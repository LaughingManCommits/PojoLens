...
- Live worker results may also emit structured `followUpTasks`; these are distinct from human-readable `followUps` and are the only coordinator-supported input for runtime task injection.
