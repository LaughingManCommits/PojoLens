...
- Mismatch: `docs/benchmarking.md`, `CONTRIBUTING.md`, and `RELEASE.md` hardcode `1.3.0` benchmark jar or tag examples while `pom.xml` declares project version `1.0.0`.
  Evidence: `pom.xml` version versus hardcoded `target/pojo-lens-1.3.0-benchmarks.jar`, `Release 1.3.0`, and `v1.3.0` examples in those docs.
