...
- `pojo-lens` is a single-module Maven Java library with `groupId` `laughing.man.commits`, `artifactId` `pojo-lens`, `version` `1.0.0`, `packaging` `jar`, and Java release `17`.
