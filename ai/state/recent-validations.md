...
- `2026-03-27`: `py -3 scripts/refresh-ai-memory.py --compact-log` passed and compacted AI event history to `12` active events plus `72` archived events in `ai/log/archive/2026-03.jsonl`.
- `2026-03-27`: `py -3 scripts/refresh-ai-memory.py --check` passed with hot context at `153` lines / `8436` bytes and SQLite cold search built.
