...
3. Fix WP13 and WP14 from the WP6-WP10 review, then run `scripts/check-doc-consistency.ps1`, `mvn -B -ntp test`, and the release guardrails.
...
- `2026-04-26`: WP13 and WP14 remain open from the WP6-WP10 review: stats-plan-cache reset semantics and SqlExpressionEvaluator null/blank validation.
...
- `2026-04-26`: Focused alias/projection coverage passed at 52/52, and the full core suite passed at 1039/1039 after the WP12 fix.
...
- Last validation: `2026-04-26` focused alias/projection suite passed at 52/52; `2026-04-26` core `mvn -B -ntp -pl pojo-lens test` passed at 1039/1039; `2026-04-24` risk-console example tests passed at 36/36.
