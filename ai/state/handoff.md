...
- Benchmark guardrail CI was fixed on 2026-03-19 by adding threshold entries for `PojoLensJoinJmhBenchmark.pojoLensJoinLeftComputedFieldOrderedLimited|size=1000/10000` in `benchmarks/thresholds.json`; local strict check now passes.
