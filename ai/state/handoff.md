...
- Focused chart regressions plus full `mvn -q test` passed after the scatter pass, and the suite now covers `444` tests after the latest consolidation helper and adapter coverage.
