...
- `2026-05-01`: `TODO.md` order is active WP36, planned WP34, deferred WP18, then Release Gate.
- `2026-05-01`: The next WP36 slice is planner decomposition, then runtime-admin cleanup/prune helpers.
