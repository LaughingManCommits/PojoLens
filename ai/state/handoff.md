...
- Is the next WP18 gain now in SQL-like setup/query execution or another real chart assembly path, now that the old projection-to-chart round-trip and the benchmark JSON export hotspot are both largely removed?
