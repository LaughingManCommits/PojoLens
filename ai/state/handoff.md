...
- Focused chart regressions plus full `mvn -q test` passed after the scatter pass, and the suite now covers `446` tests after the latest consolidation helper, adapter, and schema-index coverage.
