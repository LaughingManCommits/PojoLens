...
- `2026-04-26`: `mvn -B -ntp test` passed at 1066/1066 after WP11, and `scripts/check-doc-consistency.ps1` previously passed on the release-gate baseline.
- `2026-04-26`: `mvn -B -ntp -Plint verify -DskipTests` passed, and `scripts/check-lint-baseline.ps1` now passes after refreshing `scripts/checkstyle-baseline.txt` to `18313` entries.
