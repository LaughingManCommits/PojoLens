...
3. Check `TODO.md`; `WP8.1` through `WP8.3` are done and `WP8.4` is ready in the `Entropy Reduction` roadmap.
...
- `WP8.4` execution-path unification audit is the next executable package in `Entropy Reduction`.
...
- roadmap artifacts: `docs/entropy-audit.md`, `docs/entropy-internalization-decision.md`, `docs/entropy-wrapper-binding-decision.md`
