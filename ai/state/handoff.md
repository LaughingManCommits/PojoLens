...
3. Follow the dependency-ordered roadmap in `TODO.md`: WP28.
...
- `2026-04-30`: `TODO.md` tracks orchestration work: WP28 runtime layering, WP29 LangGraph spike, WP30 operator UX.
...
- `2026-04-30`: `TODO.md` order is WP28, WP29, WP30, then deferred WP18 and Release Gate.
