...
## Focus
- `2026-05-01`: WP32 is active. The first slice added `evaluate-run.scoreSummary` plus the tracked `example-eval-readonly-review` plan as the first eval-corpus anchor.
...
- `2026-05-01`: `TODO.md` order is active WP32, then planned WP33, planned WP34, deferred WP18, then Release Gate.
