...
3. Follow `TODO.md`: WP69 -> WP56 -> WP62 -> WP63 -> WP64 -> WP65 -> WP66 -> WP40 -> Release Gate.
4. Treat `Release Gate` as last and cut from `RELEASE.md` only when requested.

## Focus
- `2026-05-03`: WP69 is next; planner must become the first wizard stage with clarification, staged setup review, explicit approve/edit branching, and integrated handoff into run.
...
- `2026-05-03`: Queue is WP69 -> WP56 -> WP62 -> WP63 -> WP64 -> WP65 -> WP66 -> WP40 -> Release Gate.
...
- `2026-05-03`: Planner should live inside wizard, not beside it: `wizard` owns the operator workflow, planner owns clarification/decomposition, and workers start only after planner-stage approval. WP69 captures that integration rule.
