...
- The next natural-query slice should be grouped queries rather than heuristic guessing.
...
- Natural vocabulary slice last validated with `mvn -q -pl pojo-lens test`
