...
## Focus
- `2026-05-01`: WP31 active: manifests now emit run-event lineage, and retained-run `inventory`/`status` summaries now expose compact `traceSummary` rollups.
...
- `2026-05-01`: Continue WP31 with branch-local lineage/context identifiers and evaluator coverage for orchestration quality.
