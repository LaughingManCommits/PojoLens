...
- For the AI orchestration spike, decide whether to widen intent kinds first or remove raw `validationCommands` from the remaining compat worker schema now that intent-only workers reject them at the schema boundary.
