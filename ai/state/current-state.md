...
- `2026-05-02`: Preserve the current orchestrator base: guided wizard entry, async `--max-parallel`, SDK/subprocess provider fallback, transient retry, HITL gates, low-cost profiles, and typed manifest/task-plan validation.
...
## Next
- `2026-05-02`: Roadmap order is WP50 -> WP56 -> WP57 -> WP40 -> deferred WP18 -> Release Gate.
