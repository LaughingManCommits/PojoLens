...
- `2026-04-26`: `mvn -B -ntp -pl pojo-lens test` passed: 1039 tests, 0 failures.
...
- Next release gate: fix WP13 + WP14, then run release notes and final guardrails.
