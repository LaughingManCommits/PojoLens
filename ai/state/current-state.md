...
- Claude orchestration validation still needs a policy decision on whether raw commands stay long-term fallback or become compatibility-only.
...
- For the AI orchestration spike, decide whether raw validation commands should become compatibility-only, then consider widening intent kinds or any further unknown semantics.
