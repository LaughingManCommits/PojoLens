...
## Focus
- `2026-05-02`: Orchestrator role prompts now warn above `6 KB` and fail above `8 KB`, skill files warn above `3 KB` and fail above `4 KB`, and validate topology warns when a task resolves more than `4` skills.
