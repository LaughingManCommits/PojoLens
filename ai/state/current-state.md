...
- 2026-03-19 focused regressions (`FastPojoFilterSupportTest`, `ReflectionUtilTest`, `StreamsBenchmarkParityTest`) and full `mvn -q test` reruns both passed; the suite now totals `486` tests.
