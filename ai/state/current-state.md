...
- `2026-04-26`: WP15 landed. Release Gate is down to the final release guardrails; chart parity is no longer blocking.
- `2026-04-26`: Defer the unimplemented WP6/WP8/WP9 benchmark-backfill tasks until after the next release cut.
- `2026-04-26`: WP11-WP15 are complete and green.
- `2026-04-26`: `TODO.md` now queues follow-up WP16-WP18 for virtual-thread boundary evaluation, internal cleanup, and runtime-knob measurement.
...
- Release notes now cover Java 25 toolchain alignment, the WP5 performance work, and the WP11-WP15 maintenance/performance follow-ups.
...
- After the release cut, work the new Java 25 follow-up backlog in WP16-WP18.
