...
- If WP18 stays on prepared-builder setup cost, use a direct profile or narrower benchmark around rebinding/copying before trusting another short end-to-end JMH delta; current session drift obscured the duplicate-copy removal pass.
