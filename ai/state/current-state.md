...
- `2026-04-15`: `FastArrayQuerySupport` cleanup started; FA-WP1 and FA-WP2 done; FA-WP4 through FA-WP6 remain.
...
- `FastArrayQuerySupport`: FA-WP4 through FA-WP6 remain in `TODO.md`.
