...
- `2026-04-18`: `SURFACE-WP3` complete; fluent is maintainer/internal docs only and removed from stable public docs.
...
- Public API: execute `SURFACE-WP4` through `SURFACE-WP6`.
