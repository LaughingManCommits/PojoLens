...
- Claude lifecycle ergonomics now cover review/export/promote/retry/cleanup/validate-run, but validation policy depth and live prompt-budget tuning still need work.
