...
- `2026-04-29`: WP22 completed the library-first build-tooling slice: `laughing.man.commits.metamodel` now owns both single-model and batch metamodel generation, `laughing.man.commits.tooling` owns saved-report/query validation, `docs/build-tooling.md` documents the Maven wiring, and focused tooling/public-API coverage is in place.
...
- `2026-04-29`: Start WP23 with the typed join/grouping design over the existing `JoinBindings` and `DatasetBundle` concepts.
