...
| Code-owned typed filters, joins, grouped aggregates, and ordering | `TypedQuery`                               | [docs/entry-points.md](docs/entry-points.md), [docs/metamodel.md](docs/metamodel.md)                   |
