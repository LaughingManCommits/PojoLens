...
| Code-owned typed filters, joins, grouped aggregates, `HAVING`, windows, aggregate window frames, and ordering | `TypedQuery`                               | [docs/entry-points.md](docs/entry-points.md), [docs/metamodel.md](docs/metamodel.md)                   |
