...
def build_files_index(generated_at: str) -> dict[str, object]:
    ...
    important_files = [
        ...
        {"path": "scripts/quality/check-lint-baseline.ps1", "kind": "validation-script"},
        {"path": "scripts/quality/checkstyle-baseline.txt", "kind": "validation-config"},
        {"path": "scripts/release/export-release-secrets.ps1", "kind": "release-script"},
        {"path": "scripts/benchmarks/benchmark-suite-main.args", "kind": "benchmark-config"},
...
def build_config_index(generated_at: str) -> dict[str, object]:
    ...
    return {
        ...
        "aiMemory": {
            ...
            "fullRefreshCommand": "pwsh -NoProfile -ExecutionPolicy Bypass -File scripts/ai/refresh-ai-memory.ps1 -ForceFull",
            "searchCommand": "pwsh -NoProfile -ExecutionPolicy Bypass -File scripts/ai/query-ai-memory.ps1 -Query <text>",
            "benchmarkCommand": "pwsh -NoProfile -ExecutionPolicy Bypass -File scripts/ai/benchmark-ai-memory.ps1",
            "eventRetention": {
