...
```bash
java -jar target/pojo-lens-1.3.0-benchmarks.jar laughing.man.commits.benchmark.ChartVisualizationJmhBenchmark -f 1 -wi 0 -i 1 -r 100ms -rf json -rff target/benchmarks/charts/chart-benchmarks.json
