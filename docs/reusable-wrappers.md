...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `ReportDefinition<T>` | SQL-like or natural | Yes | Optional via `ChartSpec` | No built-in totals payload | Yes | Yes for SQL-like and natural reports | `withChartSpec(...)` adds chart mapping | Reusable business query contract shared across requests, jobs, or multiple consumers |
