...
- build-time metamodel/query tooling: [build-tooling.md](build-tooling.md), [metamodel.md](metamodel.md)
- file-boundary loading for CSV/TSV/JSON/JSONL: [files.md](files.md), [csv.md](csv.md)
