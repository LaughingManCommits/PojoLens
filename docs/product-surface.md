...
| Plain-English querying | `Core query engine` | Guided text authoring path for non-SQL users | `PojoLensNatural`, `NaturalQuery`, `NaturalTemplate`, `NaturalBoundQuery`, `PageResult` | `Stable` core | `README.md`, `docs/entry-points.md`, `docs/natural.md` |
| Typed DSL querying | `Core query engine` | Java-owned authoring path for refactor-friendly query composition in code | `TypedQuery`, `TypedField`, `TypedPredicate`, `TypedWindowOrder`, `PageResult` | `Stable` core | `README.md`, `docs/entry-points.md`, `docs/typed.md`, `docs/metamodel.md` |
